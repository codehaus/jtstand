...
public class TestStationPersistenceProperties extends PersistenceProperties implements Serializable {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof TestStationPersistenceProperties)) {
            return false;
        }
        TestStationPersistenceProperties other = (TestStationPersistenceProperties) object;
