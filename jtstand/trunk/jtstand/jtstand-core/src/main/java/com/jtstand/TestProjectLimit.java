...
public class TestProjectLimit extends TestLimit implements Serializable {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof TestProjectLimit)) {
            return false;
        }
        TestProjectLimit other = (TestProjectLimit) object;
